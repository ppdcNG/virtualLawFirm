...
const renderCourse = (course, id) => {
    ...
    let button = course.comingSoon && course.comingSoon == 'on' ? `<button  data-toggle = "popover" data-content = "Coming Soon" class = "btn lt-btn-accent-outline soon disabled">Comming Soon</button>` : `<a href = "/e-learning/courseDetails?id=${id}"  class = "btn lt-btn-accent">View Course</a>`
